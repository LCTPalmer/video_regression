...
train_files = './traintest_split/train_files_noduds_chunk2.txt'
...
###feature extract###
dataset_types = {'train_chunk2': train_videos} #which sets to extract features for
